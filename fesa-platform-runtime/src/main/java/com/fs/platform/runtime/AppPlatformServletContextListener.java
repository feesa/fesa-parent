...
@WebListener
public class AppPlatformServletContextListener implements ServletContextAttributeListener,ServletContextListener{ 
...
//		try {
//			List<Class<?>> classes= ClassUtils.getClasses("com.fs.app");
//			Map<String,Class> classImpl=new HashMap<String,Class>();
//			//1.获取所有接口显示类
//			for (Class class1 : classes) {
//				Annotation[] annotations=class1.getAnnotations();
//				for (Annotation annotation : annotations) {
//					if(annotation.annotationType()==FeSaFieldInit.class){
